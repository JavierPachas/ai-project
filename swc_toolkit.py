...
class ListLeaguesTool(BaseTool):
    ...
    def _run(self, league_name : Optional[str] = None,
             run_manager : Optional[CallbackManagerForToolRun] = None) -> List[League]:
        "Use the tool to get the list of leagues from SportsWorldCentral."
...
class ListTeamsTool(BaseTool):
    ...
    def _run(
        ...
        list_teams_responde = local_swc_client.list_teams(team_name = team_name, league_id = league_id)
        return list_teams_responde
